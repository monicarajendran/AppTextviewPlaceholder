#
# Be sure to run `pod lib lint AppTextviewPlaceholder.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of AppTextviewPlaceholder.'
...
TODO: Add long description of the pod here.
  ...
  s.source_files = 'AppTextviewPlaceholder/Classes/**/*'
  
  # s.resource_bundles = {
  #   'AppTextviewPlaceholder' => ['AppTextviewPlaceholder/Assets/*.png']
  # }
